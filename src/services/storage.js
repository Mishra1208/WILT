...
const STORAGE_KEYS = {
  POSTS: 'wilt_posts_v7',
  CONCEPTS: 'wilt_concepts_v7',
  LEADERBOARD: 'wilt_leaderboard_v7',
  USER: 'wilt_current_user_v7',
  SAVED_POSTS: 'wilt_saved_posts_v7',
  QUIZ_HISTORY: 'wilt_quiz_history_v7',
};

// Initialize Storage with clean real user data
export const initStorage = () => {
  // Clear any old post storage keys (v1 through v6)
  try {

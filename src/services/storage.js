...
const STORAGE_KEYS = {
  POSTS: 'wilt_posts_v15',
  CONCEPTS: 'wilt_concepts_v15',
  LEADERBOARD: 'wilt_leaderboard_v15',
  USER: 'wilt_current_user_v15',
  SAVED_POSTS: 'wilt_saved_posts_v15',
  QUIZ_HISTORY: 'wilt_quiz_history_v15',
};
...
export const getOrCreateGuestUser = () => {
  try {
    const key = 'wilt_guest_identity_v15';

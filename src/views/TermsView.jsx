    ...
    <div className="py-10 px-4 sm:px-6 max-w-4xl mx-auto space-y-10 animate-fadeIn select-none text-slate-800">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-600">
        <section className="space-y-3">
          ...
          <p>
            By accessing or contributing to WILT (What I Learned Today), created by <strong>Narendra Mishra</strong>, <strong>Avinendra Pratap Singh</strong>, and <strong>Karan Kumar</strong>, you agree to comply with these terms, our Community Standards, and all applicable university honor codes.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            WILT's interface, proprietary active recall quiz engine, gamification hierarchy, and math symbol ribbon are intellectual creations of <strong>Narendra Mishra</strong>, <strong>Avinendra Pratap Singh</strong>, and <strong>Karan Kumar</strong>. Unauthorized commercial replication or scraping is prohibited.
          </p>
        </section>

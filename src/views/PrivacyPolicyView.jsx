    ...
    <div className="py-10 px-4 sm:px-6 max-w-4xl mx-auto space-y-10 animate-fadeIn select-none text-slate-800">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-600">
        <section className="space-y-3">
          ...
          <p>
            WILT (What I Learned Today), conceived and maintained by <strong>Narendra Mishra</strong>, <strong>Avinendra Pratap Singh</strong> & <strong>Karan Kumar</strong>, is dedicated to providing an academic peer-learning ecosystem where students can share insights freely without worrying about intrusive data harvesting.
          </p>
          <p>
